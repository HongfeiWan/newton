...
- Train the Nero + L10 Diffusion Policy only from successful, deduplicated clips and use raw-episode-grouped train/validation splits; use `dataset_split.json` to reproduce or audit a run.
