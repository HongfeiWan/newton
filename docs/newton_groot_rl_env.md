...
```bash
python tools/train_newton_groot_diffusion_policy.py \
...
```bash
python tools/run_newton_groot_dp.py \
...
```bash
python tools/train_newton_groot_residual_ppo.py \
...
```bash
python tools/compare_newton_groot_dp_rollouts.py \
  checkpoints/dp/groot_l10_pick/best.pt \
...
```bash
python tools/probe_newton_l10_finger_root_load.py \
  checkpoints/dp/groot_l10_pick/best.pt \
