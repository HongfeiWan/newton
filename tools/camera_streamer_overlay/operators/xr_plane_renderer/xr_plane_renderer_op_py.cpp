...
public:
    ...
    PyXrPlaneRendererOp(holoscan::Fragment* fragment,
                        ...
                        std::shared_ptr<holoscan::XrHandTracker> left_hand_tracker,
                        std::shared_ptr<holoscan::XrHandTracker> right_hand_tracker,
                        bool verbose,
...
- Optional 3D hand skeleton overlay from OpenXR hand tracking
...
left_hand_tracker : XrHandTracker | None
    Optional left-hand tracker used for 3D skeleton overlay.
right_hand_tracker : XrHandTracker | None
    Optional right-hand tracker used for 3D skeleton overlay.
verbose : bool
...
... )
        ...
        .def(py::init<holoscan::Fragment*, const py::args&, std::shared_ptr<holoscan::XrSession>,
                      const std::vector<XrPlaneConfig>&, std::shared_ptr<holoscan::XrHandTracker>,
                      std::shared_ptr<holoscan::XrHandTracker>, bool, const std::string&>(),
             "fragment"_a,
             "xr_session"_a,
             "planes"_a,
             "left_hand_tracker"_a = nullptr,
             "right_hand_tracker"_a = nullptr,
             "verbose"_a = false,
             "name"_a = "xr_plane_renderer"s)
